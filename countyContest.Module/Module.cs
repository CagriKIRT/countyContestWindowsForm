...
namespace countyContest.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class countyContestModule : ModuleBase {
        static countyContestModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<countyContestDbContext>());
            // #endif 
        }
        public countyContestModule() {
            InitializeComponent();
        }
